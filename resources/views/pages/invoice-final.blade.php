...
<body>
								...
								<tr>
									<td>
										<div style="margin: 0px 0 20px 0; width:100%;">
											<img src="https://microgravity.co.in/images/taxinvoice.jpg" style="margin:0 0 10px 0; width:500px;">
										</div>
									</td>
								</tr>
								</tbody>
								...
								<tr>
									...
									@foreach($data['orders'] as $key=>$item)
										...
										<tr>
											...
											<td style=" border: 1px solid #ddd; padding: 7px; font-size:14px;">  {{$item->txt}}</td>
									...
									<td style="width:350px;">
										...
										<table>
											...
											<tr>
												...
												<td colspan = "2" class="qcont" style="padding: 3px; font-size:12px; text-align:left; ">  {{$digit->format($data['totalamountinctax'])}} </td>
								...
								<tr>
									<td>
										<div class="thanksline-last">
											...
											<p style="font-size:11px; color: #212529; margin:0;">Registered office: 1ST FLOOR, 18,19,20,20A,21,22,23,24, JMD EMPIRE SQUARE, MG ROAD, GURGAON, Gurgaon, Haryana, 122002 .</p>
										</div>
									</td>
								</tr>
								</tbody>
		...
		<div class="col-md-12 col-lg-9 mx-auto invoice-design" style="max-width: 800px;margin: auto; margin-top:20px; background: url('https://microgravity.co.in/images/backgrounbill.png'); background-size:contain;">
					...
					<td>
						<div>
							<table style="width:100%; text-align:center;">
								...
								<tr>
									<td>
											<img src="https://microgravity.co.in/images/termshead.jpg" style="margin:5px 0 0px 0; width:490px;">
									</td>
								</tr>
								</tbody>
							</table>
						...
						<div style="padding-bottom:10px;">
							<table>
								...
								<tr>
									<td style="font-size:11px">
									9. Consent of the parent/legal guardian is required in order to purchase tickets/bookings for minors.</td>
								</tr>
